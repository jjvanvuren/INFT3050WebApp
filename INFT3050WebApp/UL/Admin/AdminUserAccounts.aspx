                    ...
                    <asp:TemplateField HeaderText="Email" SortExpression="Email">
                        <EditItemTemplate>
                            <div class="col-xs-11 col-edit">
                                <asp:TextBox ID="txtGridEmail" runat="server" MaxLength="45" CssClass="form-control" Text='<%# Bind("title") %>'></asp:TextBox>
                            </div>
                    ...
                    <asp:TemplateField HeaderText="FirstName" SortExpression="FirstName">
                        <EditItemTemplate>
                            <div class="col-xs-3 col-edit">
                                <asp:TextBox ID="txtFirstName" runat="server" MaxLength="45" CssClass="form-control" Text='<%# Bind("FirstName") %>'></asp:TextBox>
                            </div>
